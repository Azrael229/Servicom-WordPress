...
class Review_Comparison_Block extends Base_Block {
	...
	protected function render( $attributes ) {
		...
		foreach ( $attributes['reviews'] as $review ) {
			...
			if ( isset( $block['attrs']['product'] ) && intval( $block['attrs']['product'] ) >= 0 && class_exists( 'WooCommerce' ) ) {
				...
				$block['attrs']['links'] = array(
					array(
						'label'       => __( 'Buy Now', 'otter-blocks', 'themeisle-companion' ),
			...
			if ( isset( $block['attrs']['image'] ) ) {
				...
				$table_title .= $block['attrs']['title'] ? $block['attrs']['title'] : __( 'Untitled review', 'otter-blocks', 'themeisle-companion' );
				$table_title .= '</a>';
			}
			$table_title .= '</td>';
		...
		$html .= '	<tbody>';
		$html .= '		<tr>';
		$html .= '			<th>' . __( 'Name', 'otter-blocks', 'themeisle-companion' ) . '</th>';
		$html .= $table_title;
		$html .= '		</tr>';

		$html .= '		<tr>';
		$html .= '			<th>' . __( 'Price', 'otter-blocks', 'themeisle-companion' ) . '</th>';
		$html .= $table_price;
		$html .= '		</tr>';

		$html .= '		<tr>';
		$html .= '			<th>' . __( 'Rating', 'otter-blocks', 'themeisle-companion' ) . '</th>';
		$html .= $table_ratings;
		$html .= '		</tr>';

		$html .= '		<tr>';
		$html .= '			<th>' . __( 'Description', 'otter-blocks', 'themeisle-companion' ) . '</th>';
		$html .= $table_description;
		$html .= '		</tr>';

		$html .= '		<tr>';
		$html .= '			<th>' . __( 'Statistics', 'otter-blocks', 'themeisle-companion' ) . '</th>';
		$html .= $table_features;
		$html .= '		</tr>';

		$html .= '		<tr>';
		$html .= '			<th>' . __( 'Buy this product', 'otter-blocks', 'themeisle-companion' ) . '</th>';
		$html .= $table_links;
		$html .= '		</tr>';
		$html .= '	</tbody>';
		$html .= '</table>';
